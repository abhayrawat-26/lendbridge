document.addEventListener("DOMContentLoaded", function() {
  ...
  function validateFieldsAndToggleButtons() {
    ...
    const emailButton = document.querySelectorAll("[email-btn='true']");
    const fullNameField = document.querySelector("[full-name-field='true']");
    const fullNameButton = document.querySelectorAll("[full-name-btn='true']");
    const phoneNumberField = document.querySelector("[phone-number='true']");
    const phoneButton = document.querySelectorAll("[phone-btn='true']");
    ...
    const assetButton = document.querySelectorAll("[asset-btn='true']");
    ...
    const realEstateButton = document.querySelectorAll("[real-estate-btn='true']");
    const estimatedValueField = document.querySelector("[estimated-value='true']");
    const estimatedValueButton = document.querySelectorAll("[estimated-value-btn='true']");
    const assetImageField = document.getElementById('asset-image');
    const assetImageButton = document.querySelectorAll("[asset-image-btn='true']");
